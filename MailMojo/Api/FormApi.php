...
class FormApi
{
    ...
    {
        list($response) = $this->updateFormWithHttpInfo($id);
        return $response;
    }
     ...
     * @return array of \MailMojo\MailMojo\Model\Form, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateFormWithHttpInfo($id)
    {
        $returnType = '\MailMojo\MailMojo\Model\Form';
        $request = $this->updateFormRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFormAsync($id)
    {
        return $this->updateFormAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFormAsyncWithHttpInfo($id)
    {
        $returnType = '\MailMojo\MailMojo\Model\Form';
        $request = $this->updateFormRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateFormRequest($id)
    {
