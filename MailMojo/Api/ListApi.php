...
class ListApi
{
     ...
     * @param  \MailMojo\MailMojo\Model\Contacts[] $contacts contacts (optional)
     *
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $list_id ID of the email list to subscribe to. (required)
     * @param  \MailMojo\MailMojo\Model\Contacts[] $contacts (optional)
     *
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importSubscribersToListAsync($list_id, $contacts = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importSubscribersToListAsyncWithHttpInfo($list_id, $contacts = null)
    {
        $returnType = '\MailMojo\MailMojo\Model\ImportResult';
        $request = $this->importSubscribersToListRequest($list_id, $contacts);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function importSubscribersToListRequest($list_id, $contacts = null)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        $returnType = '\MailMojo\MailMojo\Model\ListDetail';
        $request = $this->updateListRequest($list_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateListAsync($list_id)
    {
        return $this->updateListAsyncWithHttpInfo($list_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateListAsyncWithHttpInfo($list_id)
    {
        $returnType = '\MailMojo\MailMojo\Model\ListDetail';
        $request = $this->updateListRequest($list_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateListRequest($list_id)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
