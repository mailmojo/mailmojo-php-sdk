...
class TemplateApi
{
     ...
     * @return \MailMojo\MailMojo\Model\Template[]
     */
     ...
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailMojo\MailMojo\Model\Template[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getTemplatesWithHttpInfo()
    {
        $returnType = '\MailMojo\MailMojo\Model\Template[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailMojo\MailMojo\Model\Template[]',
