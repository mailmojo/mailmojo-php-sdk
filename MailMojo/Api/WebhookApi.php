...
class WebhookApi
{
     ...
     * Create a webhook.
     *
     * @param  \MailMojo\MailMojo\Model\Webhook $config config (optional)
     *
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailMojo\MailMojo\Model\Webhook
     */
    public function createWebhook($config = null)
    {
        list($response) = $this->createWebhookWithHttpInfo($config);
        return $response;
    }
     ...
     * Create a webhook.
     *
     * @param  \MailMojo\MailMojo\Model\Webhook $config (optional)
     *
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailMojo\MailMojo\Model\Webhook, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWebhookWithHttpInfo($config = null)
    {
        $returnType = '\MailMojo\MailMojo\Model\Webhook';
        $request = $this->createWebhookRequest($config);
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailMojo\MailMojo\Model\Webhook',
     ...
     */
    public function createWebhookAsync($config = null)
    {
        return $this->createWebhookAsyncWithHttpInfo($config)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWebhookAsyncWithHttpInfo($config = null)
    {
        $returnType = '\MailMojo\MailMojo\Model\Webhook';
        $request = $this->createWebhookRequest($config);
     ...
     */
    protected function createWebhookRequest($config = null)
    {
