...
class NewsletterApi
{
     ...
     * @return \MailMojo\MailMojo\Model\Newsletter
     */
     ...
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailMojo\MailMojo\Model\Newsletter, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelNewsletterWithHttpInfo($newsletter_id)
    {
        $returnType = '\MailMojo\MailMojo\Model\Newsletter';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailMojo\MailMojo\Model\Newsletter',
    ...
    protected function cancelNewsletterRequest($newsletter_id)
    {
        ...
        $resourcePath = '/newsletters/{newsletter_id}/cancel/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \MailMojo\MailMojo\Model\NewsletterCreation $config config (optional)
     *
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailMojo\MailMojo\Model\Newsletter
     */
    public function createNewsletter($config = null)
    {
        list($response) = $this->createNewsletterWithHttpInfo($config);
        return $response;
    }
     ...
     * Create a newsletter draft.
     *
     * @param  \MailMojo\MailMojo\Model\NewsletterCreation $config (optional)
     *
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailMojo\MailMojo\Model\Newsletter, HTTP status code, HTTP response headers (array of strings)
     */
    public function createNewsletterWithHttpInfo($config = null)
    {
        $returnType = '\MailMojo\MailMojo\Model\Newsletter';
        $request = $this->createNewsletterRequest($config);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNewsletterAsync($config = null)
    {
        return $this->createNewsletterAsyncWithHttpInfo($config)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNewsletterAsyncWithHttpInfo($config = null)
    {
        $returnType = '\MailMojo\MailMojo\Model\Newsletter';
        $request = $this->createNewsletterRequest($config);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createNewsletterRequest($config = null)
    {
    ...
    protected function getNewsletterByIdRequest($newsletter_id)
    {
        ...
        $resourcePath = '/newsletters/{newsletter_id}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailMojo\MailMojo\Model\PaginatedResult
     */
     ...
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailMojo\MailMojo\Model\PaginatedResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getNewslettersWithHttpInfo($page = '1', $per_page = '25', $type = null)
    {
        $returnType = '\MailMojo\MailMojo\Model\PaginatedResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailMojo\MailMojo\Model\PaginatedResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function sendNewsletterRequest($newsletter_id, $config = null)
    {
        ...
        $resourcePath = '/newsletters/{newsletter_id}/send/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $newsletter_id ID of the newsletter to retrieve. (required)
     * @param  \MailMojo\MailMojo\Model\NewsletterSendTest $config config (optional)
     *
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function testNewsletter($newsletter_id, $config = null)
    {
     ...
     *
     * @param  int $newsletter_id ID of the newsletter to retrieve. (required)
     * @param  \MailMojo\MailMojo\Model\NewsletterSendTest $config (optional)
     *
     * @throws \MailMojo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function testNewsletterWithHttpInfo($newsletter_id, $config = null)
    {
        $returnType = '';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testNewsletterAsync($newsletter_id, $config = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testNewsletterAsyncWithHttpInfo($newsletter_id, $config = null)
    {
        $returnType = '';
        $request = $this->testNewsletterRequest($newsletter_id, $config);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testNewsletterRequest($newsletter_id, $config = null)
    {
        // verify the required parameter 'newsletter_id' is set
        if ($newsletter_id === null || (is_array($newsletter_id) && count($newsletter_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/newsletters/{newsletter_id}/send_test/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->updateNewsletterWithHttpInfo($id);
        return $response;
    }
     ...
     * @return array of \MailMojo\MailMojo\Model\Newsletter, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateNewsletterWithHttpInfo($id)
    {
        $returnType = '\MailMojo\MailMojo\Model\Newsletter';
        $request = $this->updateNewsletterRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateNewsletterAsync($id)
    {
        return $this->updateNewsletterAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateNewsletterAsyncWithHttpInfo($id)
    {
        $returnType = '\MailMojo\MailMojo\Model\Newsletter';
        $request = $this->updateNewsletterRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateNewsletterRequest($id)
    {
